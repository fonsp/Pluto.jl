...
plot(heatmap(z=Float32.(b),colorscale="Greys"),Layout(template=templates.presentation, yaxis = attr(showgrid=false, scaleanchor="x")))
...
md"""
Choose operation: $(@bind s Select([1 => "crop", 2 => "fill", 3 => "plot"]) )
