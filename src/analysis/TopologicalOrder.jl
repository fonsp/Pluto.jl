...
topological_order(::Notebook, topology::NotebookTopology, roots::Vector{Cell}; allow_multiple_defs=false) = topological_order(topology, roots; allow_multiple_defs=allow_multiple_defs)
