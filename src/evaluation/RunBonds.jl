function set_bond_values_reactive(;
    ...
    function custom_deletion_hook((session, notebook)::Tuple{ServerSession,Notebook}, old_workspace_name, new_workspace_name, to_delete_vars::Set{Symbol}, methods_to_delete, to_reimport, cells_to_macro_invalidate, cells_to_js_link_invalidate; to_run)
