...
const default_binder_url = "https://mybinder.org/v2/gh/fonsp/pluto-on-binder/v$(string(JIVEBOOK_VERSION))"
...
function cdnified_html(filename::AbstractString;
    ...
    should_use_bundled_cdn = version ∈ (nothing, JIVEBOOK_VERSION) && pluto_cdn_root === nothing
    ...
    something(
        if should_use_bundled_cdn
            try
                ...
                cdn_root = "https://cdn.jsdelivr.net/gh/fonsp/Pluto.jl@$(string(JIVEBOOK_VERSION))/frontend-dist/"
        ...
        let
            ...
            cdn_root = something(pluto_cdn_root, "https://cdn.jsdelivr.net/gh/fonsp/Pluto.jl@$(something(cdn_version_override, string(something(version, JIVEBOOK_VERSION))))/frontend/")
