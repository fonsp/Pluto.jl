            ...
            ${null!=window.plutoDesktop?(0,r.html)`<${s.FilePicker}
                  ...
                  >
                      ...
                      <a
                          ...
                          title=${e.path}
                          onClick=${o=>{t||(a(P(e.path,d)),u(e.path,{transitioning:!0}))}}
                          >${P(e.path,d)}</a
                      >
