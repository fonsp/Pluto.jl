            ...
            />`}
                  ...
                  >
                      ...
                      <a
                          ...
                          title=${t.path}
                          onClick=${e=>{i||(l(E(t.path,u)),c(t.path,{transitioning:!0}))}}
                          >${E(t.path,u)}</a
                      >
...
`,O=[{title:"Notebooks",tags:"everything"}],R=e=>(null==e?void 0:e.id)??e.url,M=({sources:e,direct_html_links:t})=>{const[o,n]=r.useState({});r.useEffect((()=>{if(null!=e){i(!1),n({});const t=Array.from(new Set(e.map(R))).map((t=>{const o=e.filter((e=>R(e)===t));return I(o.map((async e=>{const{url:o,integrity:n,valid_until:r}=e;if(null!=r&&new Date(r)<new Date)throw new Error(`Source ${o} is expired with valid_until ${r}`);const l=await(await fetch(new Request(o,{integrity:n??void 0}))).json();if("1"!==l.format_version)throw new Error(`Invalid format version: ${l.format_version}`);return[l,t,o]}))).then((([e,t,o])=>{n((n=>({...n,[t]:{...e,source_url:o}})))}))}));Promise.any(t).catch((e=>{console.error("All featured sources failed to load: ",e),((null==e?void 0:e.errors)??[]).forEach((e=>console.error(e))),i(!0)}))}}),[e]),r.useEffect((()=>{Object.entries(o).length>0&&console.log("Sources:",o)}),[o]);const[l,i]=r.useState(!1);r.useEffect((()=>{setTimeout((()=>{i(!0)}),8e3)}),[]);const a=0===Object.entries(o).length,s=Array.from(new Set((null==e?void 0:e.map(R))??[])).map((e=>o[e])).filter((e=>null!=e));return a&&l?A:r.html`
              ${(a?T:s).map((e=>{let o=(null==e?void 0:e.collections)??O;return r.html`
                      <div class="featured-source">
                          <h1>${e.title}</h1>
                          <p>${e.description}</p>
                          ${o.map((o=>r.html`
                                  <div class="collection">
                                      ...
                                      <p>${o.description}</p>
                                      <div class="card-list">
                                          ${D(Object.values(e.notebooks),o.tags??[]).map((o=>r.html`<${N.FeaturedCard} entry=${o} source_manifest=${e} direct_html_links=${t} />`))}
                                      </div>
                                  </div>
                              `))}
                      </div>
