...
codec.addExtPacker(0x11, (buffer) => new Int8Array(buffer))
codec.addExtPacker(0x12, (buffer) => new Uint8Array(buffer))
codec.addExtPacker(0x13, (buffer) => new Int16Array(buffer))
codec.addExtPacker(0x14, (buffer) => new Uint16Array(buffer))
codec.addExtPacker(0x15, (buffer) => new Int32Array(buffer))
codec.addExtPacker(0x16, (buffer) => new Uint32Array(buffer))
codec.addExtPacker(0x17, (buffer) => new Float32Array(buffer))
codec.addExtPacker(0x18, (buffer) => new Float64Array(buffer))
