...
const msgpack_lite_js_1 = __importDefault(require("../imports/msgpack-lite.js"));
// based on https://github.com/kawanet/msgpack-lite/blob/5b71d82cad4b96289a466a6403d2faaa3e254167/lib/ext-packer.js
const codec = msgpack_lite_js_1.default.createCodec();
...
/** @param {any} x */
const pack = (x) => {
    return msgpack_lite_js_1.default.encode(x, { codec: codec });
};
exports.pack = pack;
/** @param {Uint8Array} x */
const unpack = (x) => {
    return msgpack_lite_js_1.default.decode(x, { codec: codec });
};
