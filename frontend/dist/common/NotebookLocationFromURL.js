...
exports.guess_notebook_location = void 0;
...
const guess_notebook_location = async (path_or_url) => {
    try {
        ...
        if (u.host === "gist.github.com") {
            ...
            const gist = await (await fetch(`https://api.github.com/gists/${gist_id}`, {
                headers: { Accept: "application/vnd.github.v3+json" },
            }).then((r) => (r.ok ? r : Promise.reject(r)))).json();
            console.log(gist);
...
exports.guess_notebook_location = guess_notebook_location;
