...
exports.add_bonds_listener = exports.add_bonds_disabled_message_handler = exports.set_bound_elements_to_their_value = exports.set_input_value = void 0;
exports.get_input_value = get_input_value;
exports.eventof = eventof;
...
const SetupCellEnvironment_js_1 = __importDefault(require("./SetupCellEnvironment.js"));
/**
...
function input_generator(input) {
    return SetupCellEnvironment_js_1.default.Generators.observe(function (change) {
        var event = eventof(input), value = get_input_value(input);
        function inputted() {
...
const set_bound_elements_to_their_value = (bond_nodes, bond_values) => {
    bond_nodes.forEach((bond_node) => {
        ...
        if (bond_name != null && bond_node.firstElementChild != null && bond_values[bond_name] != null) {
            ...
            try {
                (0, exports.set_input_value)(bond_node.firstElementChild, val);
            }
            catch (error) {
...
exports.set_bound_elements_to_their_value = set_bound_elements_to_their_value;
/**
 * @param {NodeListOf<Element>} bond_nodes
        ...
        const listener = (e) => {
            if (e.target.closest(".bonds_disabled:where(.offer_binder, .offer_local)")) {
                (0, open_pluto_popup_js_1.open_pluto_popup)({
                    ...
                    body: (0, Preact_js_1.html) `${`You are viewing a static document. `}
                        <a
                            href="#"
                            onClick=${(e) => {
                        //@ts-ignore
...
exports.add_bonds_disabled_message_handler = add_bonds_disabled_message_handler;
/**
 * @param {NodeListOf<Element>} bond_nodes
...
const add_bonds_listener = (bond_nodes, on_bond_change, known_values, invalidation) => {
    ...
    bond_nodes.forEach(async (bond_node) => {
        ...
        if (name != null && bound_element_node != null) {
            ...
            let skip_initialize = Object.keys(known_values).includes(name) && lodash_js_1.default.isEqual(known_values[name]?.value, initial_value);
...
exports.add_bonds_listener = add_bonds_listener;
/**
