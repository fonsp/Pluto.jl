...
exports.detect_deserializer = void 0;
exports.serialize_cells = serialize_cells;
exports.deserialize_cells = deserialize_cells;
exports.deserialize_repl = deserialize_repl;
/**
...
const detect_deserializer = (/** @type {string} */ topaste) => topaste.trim().startsWith(JULIA_REPL_PROMPT)
    ? deserialize_repl
    : topaste.match(/# ╔═╡ ........-....-....-....-............/g)?.length
        ? deserialize_cells
        : null;
exports.detect_deserializer = detect_deserializer;
