...
exports.create_pluto_connection = exports.ws_address_from_base = exports.resolvable_promise = exports.timeout_promise = void 0;
...
exports.timeout_promise = timeout_promise;
/**
 ...
 */
const retry_until_resolved = (f, time_ms) => (0, exports.timeout_promise)(f(), time_ms).catch((e) => {
    console.error(e);
...
exports.resolvable_promise = resolvable_promise;
/**
 * @returns {string}
 */
...
const create_ws_connection = (address, { on_message, on_socket_close }, timeout_s = 30) => {
    return new Promise((resolve, reject) => {
        ...
        const send_encoded = (message) => {
            const encoded = (0, MsgPack_js_1.pack)(message);
        ...
        socket.onmessage = (event) => {
            ...
            last_task = last_task.then(async () => {
                try {
                    ...
                    const message = (0, MsgPack_js_1.unpack)(new Uint8Array(buffer));
                    try {
                        on_message(message);
                    }
                    catch (process_err) {
...
const ws_address_from_base = (/** @type {string | URL} */ base_url) => {
    ...
    const ws_url_with_secret = (0, URLTools_js_1.with_query_params)(ws_url, { secret: new URL(base_url).searchParams.get("secret") });
    return ws_url_with_secret;
};
exports.ws_address_from_base = ws_address_from_base;
const default_ws_address = () => (0, exports.ws_address_from_base)(window.location.href);
/**
 ...
 */
const create_pluto_connection = async ({ on_unrequested_update, on_reconnect, on_connection_status, connect_metadata = {}, ws_address = default_ws_address(), }) => {
    let ws_connection = /** @type {WebsocketConnection?} */ (null); // will be defined later i promise
    const message_log = new Stack_js_1.Stack(100);
    // @ts-ignore
    ...
    const send = async (message_type, body = {}, metadata = {}, no_broadcast = true) => {
        ...
        let p = (0, exports.resolvable_promise)();
        ...
        try {
            ws_connection = await create_ws_connection(String(ws_address), {
                ...
                on_socket_close: async () => {
                    ...
                    await SetupCellEnvironment_js_1.Promises.delay(reconnect_after_close_delay);
            ...
            await SetupCellEnvironment_js_1.Promises.delay(retry_after_connect_failure_delay);
...
exports.create_pluto_connection = create_pluto_connection;
