...
exports.commentKeymap = exports.blockUncomment = exports.blockComment = exports.toggleBlockComment = exports.lineUncomment = exports.lineComment = exports.toggleLineComment = exports.toggleComment = void 0;
const CodemirrorPlutoSetup_js_1 = require("../../imports/CodemirrorPlutoSetup.js");
/// Comment or uncomment the current selection. Will use line comments
/// if available, otherwise falling back to block comments.
const toggleComment = (target) => {
    let config = getConfig(target.state);
    return config.line ? (0, exports.toggleLineComment)(target) : config.block ? (0, exports.toggleBlockComment)(target) : false;
};
...
exports.toggleLineComment = command(changeLineComment, 0 /* Toggle */);
/// Comment the current selection using line comments.
exports.lineComment = command(changeLineComment, 1 /* Comment */);
/// Uncomment the current selection using line comments.
exports.lineUncomment = command(changeLineComment, 2 /* Uncomment */);
/// Comment or uncomment the current selection using block comments.
/// The block comment syntax is taken from the
/// [`commentTokens`](#comment.CommentTokens) [language
/// data](#state.EditorState.languageDataAt).
exports.toggleBlockComment = command(changeBlockComment, 0 /* Toggle */);
/// Comment the current selection using block comments.
exports.blockComment = command(changeBlockComment, 1 /* Comment */);
/// Uncomment the current selection using block comments.
exports.blockUncomment = command(changeBlockComment, 2 /* Uncomment */);
/// Default key bindings for this package.
///
///  - Ctrl-/ (Cmd-/ on macOS): [`toggleComment`](#comment.toggleComment).
///  - Shift-Alt-a: [`toggleBlockComment`](#comment.toggleBlockComment).
exports.commentKeymap = [
    { key: "Mod-/", run: exports.toggleComment },
    { key: "Alt-A", run: exports.toggleBlockComment },
];
    ...
    if (option != 2 /* Uncomment */ && !comments.every((c) => c)) {
        ...
        return state.changeByRange((range) => {
            ...
            return {
                ...
                range: CodemirrorPlutoSetup_js_1.EditorSelection.range(range.anchor + shift, range.head + shift),
            };
        });
    }
