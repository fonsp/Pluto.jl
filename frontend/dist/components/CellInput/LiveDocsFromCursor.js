...
exports.get_selected_doc_from_state = void 0;
...
let get_selected_doc_from_state = (/** @type {EditorState} */ state, verbose = false) => {
    ...
    let scopestate = state.field(scopestate_statefield_js_1.ScopeStateField);
    if (selection.empty) {
        ...
        let tree = (0, CodemirrorPlutoSetup_js_1.syntaxTree)(state);
        ...
        do {
            ...
            try {
                ...
                if ((cursor.name === "Operator" || cursor.name === "⚠" || cursor.name === "Identifier") &&
...
exports.get_selected_doc_from_state = get_selected_doc_from_state;
