...
exports.update_stored_recent_notebooks = exports.Editor = exports.url_logo_small = exports.default_path = void 0;
...
const Feedback_js_1 = require("../common/Feedback.js");
const Serialization_js_1 = require("../common/Serialization.js");
const FilePicker_js_1 = require("./FilePicker.js");
const Preamble_js_1 = require("./Preamble.js");
const Notebook_js_1 = require("./Notebook.js");
const BottomRightPanel_js_1 = require("./BottomRightPanel.js");
const DropRuler_js_1 = require("./DropRuler.js");
const SelectionArea_js_1 = require("./SelectionArea.js");
const UndoDelete_js_1 = require("./UndoDelete.js");
const SlideControls_js_1 = require("./SlideControls.js");
const Scroller_js_1 = require("./Scroller.js");
const ExportBanner_js_1 = require("./ExportBanner.js");
...
const SetupMathJax_js_1 = require("../common/SetupMathJax.js");
const SliderServerClient_js_1 = require("../common/SliderServerClient.js");
const ProgressBar_js_1 = require("./ProgressBar.js");
const NonCellOutput_js_1 = require("./NonCellOutput.js");
const Cell_js_1 = require("./Cell.js");
const RecordingUI_js_1 = require("./RecordingUI.js");
const HijackExternalLinksToOpenInNewTab_js_1 = require("./HackySideStuff/HijackExternalLinksToOpenInNewTab.js");
const FrontmatterInput_js_1 = require("./FrontmatterInput.js");
const LaunchBackendButton_js_1 = require("./Editor/LaunchBackendButton.js");
 ...
 * */
const Main = ({ children }) => {
    return (0, Preact_js_1.html) `<main>${children}</main>`;
};
/**
...
const statusmap = (/** @type {EditorState} */ state, /** @type {LaunchParameters} */ launch_params) => ({
    ...
    loading: (state.backend_launch_phase != null &&
        Binder_js_1.BackendLaunchPhase.wait_for_user < state.backend_launch_phase &&
        state.backend_launch_phase < Binder_js_1.BackendLaunchPhase.ready) ||
        state.initializing ||
        state.moving_file,
    process_waiting_for_permission: state.notebook.process_status === ProcessStatus_js_1.ProcessStatus.waiting_for_permission && !state.initializing,
    process_restarting: state.notebook.process_status === ProcessStatus_js_1.ProcessStatus.waiting_to_restart,
    process_dead: state.notebook.process_status === ProcessStatus_js_1.ProcessStatus.no_process || state.notebook.process_status === ProcessStatus_js_1.ProcessStatus.waiting_to_restart,
    ...
    bonds_disabled: !(state.initializing ||
    ...
    offer_binder: state.backend_launch_phase === Binder_js_1.BackendLaunchPhase.wait_for_user && launch_params.binder_url != null,
    offer_local: state.backend_launch_phase === Binder_js_1.BackendLaunchPhase.wait_for_user && launch_params.pluto_server_url != null,
    binder: launch_params.binder_url != null && state.backend_launch_phase != null,
    code_differs: state.notebook.cell_order.some((cell_id) => state.cell_inputs_local[cell_id] != null && state.notebook.cell_inputs[cell_id].code !== state.cell_inputs_local[cell_id].code),
    ...
    sanitize_html: state.notebook.process_status === ProcessStatus_js_1.ProcessStatus.waiting_for_permission,
});
 ...
 * }}
 */
const url_logo_big = (0, external_source_js_1.get_included_external_source)("pluto-logo-big")?.href;
exports.url_logo_small = (0, external_source_js_1.get_included_external_source)("pluto-logo-small")?.href;
/**
 * @typedef EditorProps
 * @type {{
 ...
 */
class Editor extends Preact_js_1.Component {
    constructor(/** @type {EditorProps} */ props) {
        ...
        this.state = {
            ...
            backend_launch_phase: launch_params.notebookfile != null && (launch_params.binder_url != null || launch_params.pluto_server_url != null)
                ? Binder_js_1.BackendLaunchPhase.wait_for_user
                : null,
        ...
        this.real_actions = {
            ...
            set_local_cell: (cell_id, new_val) => {
                return this.setStatePromise((0, immer_js_1.default)((/** @type {EditorState} */ state) => {
            ...
            get_unsubmitted_global_definitions: () => lodash_js_1.default.pick(this.state.unsumbitted_global_definitions, this.state.notebook.cell_order),
            ...
            add_deserialized_cells: async (data, index_or_id, deserializer = Serialization_js_1.deserialize_cells) => {
                 ...
                 * See ** 1 **
                 */
                this.setState((0, immer_js_1.default)((/** @type {EditorState} */ state) => {
            ...
            wrap_remote_cell: async (cell_id, block_start = "begin", block_end = "end") => {
                ...
                await this.setStatePromise((0, immer_js_1.default)((/** @type {EditorState} */ state) => {
                    state.cell_inputs_local[cell_id] = {
                        code: new_code,
                    };
                }));
            ...
            split_remote_cell: async (cell_id, boundaries, submit = false) => {
                ...
                /** @type {Array<String>} */
                const parts = boundaries.map((b, i) => (0, UnicodeTools_js_1.slice_utf8)(old_code, padded_boundaries[i], b).trim()).filter((x) => x !== "");
            ...
            set_and_run_all_changed_remote_cells: () => {
                const changed = this.state.notebook.cell_order.filter((cell_id) => this.state.cell_inputs_local[cell_id] != null &&
            ...
            set_and_run_multiple: async (cell_ids) => {
                ...
                if (cell_ids.length > 0) {
                    window.dispatchEvent(new CustomEvent("set_waiting_to_run_smart", {
                        detail: {
                            cell_ids,
                        },
                    }));
            ...
            reshow_cell: (cell_id, objectid, dim) => this.client.send("reshow_cell", {
                objectid,
                dim,
                cell_id,
            }, { notebook_id: this.state.notebook.notebook_id }, false),
            request_js_link_response: (cell_id, link_id, input) => {
                return this.client
                    .send("request_js_link_response", {
                    cell_id,
                    link_id,
                    input,
            ...
            get_selected_cells: (cell_id, /** @type {boolean} */ allow_other_selected_cells) => allow_other_selected_cells ? this.state.selected_cells : [cell_id],
        ...
        const apply_notebook_patches = (patches, /** @type {NotebookData?} */ old_state = null, get_reverse_patches = false) => new Promise((resolve) => {
            if (patches.length !== 0) {
                const should_ignore_patch_error = (/** @type {string} */ failing_path) => failing_path.startsWith("status_tree");
                let _copy_of_patches, reverse_of_patches = [];
                this.setState((0, immer_js_1.default)((/** @type {EditorState} */ state) => {
                    let new_notebook;
                    try {
                        ...
                        if (get_reverse_patches) {
                            ;
                            [new_notebook, _copy_of_patches, reverse_of_patches] = (0, immer_js_1.produceWithPatches)(old_state ?? state.notebook, (state) => {
                                (0, immer_js_1.applyPatches)(state, patches);
                            });
                            // TODO: why was `new_notebook` not updated?
                            // this is why the line below is also called when `get_reverse_patches === true`
                        }
                        new_notebook = (0, immer_js_1.applyPatches)(old_state ?? state.notebook, patches);
                    }
                    catch (exception) {
                        /** @type {String} Example: `"a.b[2].c"` */
                        const failing_path = String(exception).match(".*'(.*)'.*")?.[1].replace(/\//gi, ".") ?? exception;
                        const path_value = lodash_js_1.default.get(this.state.notebook, failing_path, "Not Found");
...
patch: ${JSON.stringify(patches?.find(({ path }) => path.join("") === failing_path), null, 1)}
all patches: ${JSON.stringify(patches, null, 1)}
#######################**************************########################`, exception);
                        let parts = failing_path.split(".");
                        for (let i = 0; i < parts.length; i++) {
                            let path = parts.slice(0, i).join(".");
                            console.log(path, lodash_js_1.default.get(this.state.notebook, path, "Not Found"));
                        }
                        if (ignore) {
                            ...
                            (0, open_pluto_popup_js_1.open_pluto_popup)({
                                type: "warn",
                                body: (0, Preact_js_1.html) `Something went wrong while updating the notebook state. Please refresh the page to try again.`,
                            });
                        }
                        else {
        ...
        const on_update = (update, by_me) => {
            if (this.state.notebook.notebook_id === update.notebook_id) {
                ...
                if (show_debugs)
                    console.debug("on_update", update, by_me);
                ...
                switch (update.type) {
                    case "notebook_diff":
                        ...
                        if (message?.response?.from_reset) {
                            ...
                            apply_promise = apply_notebook_patches(message.patches, (0, editor_js_1.empty_notebook_state)({ notebook_id: this.state.notebook.notebook_id })).catch((e) => {
                                alert("Oopsie!! please refresh your browser and everything will be alright!");
                                throw e;
                            });
                        }
        ...
        const on_establish_connection = async (client) => {
            ...
            if (this.props.launch_params.disable_ui !== true)
                check_access(this.client);
            // @ts-ignore
            ...
            this.setState({
                ...
                backend_launch_phase: this.state.backend_launch_phase == null ? null : Binder_js_1.BackendLaunchPhase.ready,
            });
            this.client.send("complete", { query: "sq" }, { notebook_id: this.state.notebook.notebook_id });
            this.client.send("complete", { query: "\\sq" }, { notebook_id: this.state.notebook.notebook_id });
            setTimeout(Feedback_js_1.init_feedback, 2 * 1000); // 2 seconds - load feedback a little later for snappier UI
        };
        const on_connection_status = (val, hopeless) => {
            ...
            if (hopeless) {
                ...
                (0, open_pluto_popup_js_1.open_pluto_popup)({
                    type: "warn",
                    body: (0, Preact_js_1.html) `<p>A new server was started - this notebook session is no longer running.</p>
        ...
        const on_reconnect = async () => {
            ...
            await this.client.send("reset_shared_state", {}, {
                notebook_id: this.state.notebook.notebook_id,
            }, false);
            return true;
        };
        this.export_url = (/** @type {string} */ u) => this.state.binder_session_url == null
        ...
        this.connect = (/** @type {string | undefined} */ ws_address = undefined) => (0, PlutoConnection_js_1.create_pluto_connection)({
        ...
        this.on_disable_ui = () => {
            (0, editor_js_1.set_disable_ui_css)(this.state.disable_ui, props.pluto_editor_element);
            ...
            this.state.disable_ui || (launch_params.slider_server_url != null && !this.state.connected)
                ? // then use a modified set of actions
                    launch_params.slider_server_url != null
                        ? (0, SliderServerClient_js_1.slider_server_actions)({
                        ...
                        : (0, SliderServerClient_js_1.nothing_actions)({
                            actions: this.actions,
                        })
        ...
        setInterval(() => {
            if (!this.state.static_preview && document.visibilityState === "visible") {
                ...
                //@ts-ignore
                (0, Binder_js_1.count_stat)(`editing/${window?.version_info?.pluto ?? this.state.notebook.pluto_version ?? "unknown"}${window.plutoDesktop ? "-desktop" : ""}`);
            }
        }, 1000 * 15 * 60);
        setInterval(() => {
            if (!this.state.static_preview && document.visibilityState === "visible") {
                (0, exports.update_stored_recent_notebooks)(this.state.notebook.path);
            }
        }, 1000 * 5);
        ...
        this.maybe_send_queued_bond_changes = () => {
            if (this.notebook_is_idle() && this.bond_changes_to_apply_when_done.length !== 0) {
                ...
                this.update_notebook((notebook) => {
                    (0, immer_js_1.applyPatches)(notebook, bonds_patches);
                });
            }
        };
         ...
         */
        this.js_init_set = new PlutoContext_js_1.SetWithEmptyCallback(() => {
        ...
        this.notebook_is_idle = () => {
            return !(this.waiting_for_bond_to_trigger_execution ||
                ...
                !lodash_js_1.default.isEmpty(this.js_init_set) ||
                !this.is_process_ready());
        };
        this.is_process_ready = () => this.state.notebook.process_status === ProcessStatus_js_1.ProcessStatus.starting || this.state.notebook.process_status === ProcessStatus_js_1.ProcessStatus.ready;
        const bond_will_trigger_evaluation = (/** @type {string|PropertyKey} */ sym) => Object.entries(this.state.notebook.cell_dependencies).some(([cell_id, deps]) => {
         ...
         */
        const bond_patch_will_trigger_evaluation = (/** @type {Patch} */ x) => x.op === "replace" && x.path.length >= 1 && bond_will_trigger_evaluation(x.path[1]);
        ...
        let update_notebook = (mutate_fn) => {
            const new_task = last_update_notebook_task.then(async () => {
                ...
                //     return
                // }
                let [new_notebook, changes, inverseChanges] = (0, immer_js_1.produceWithPatches)(this.state.notebook, (notebook) => {
                    mutate_fn(notebook);
                });
        ...
        window.shutdownNotebook = this.close = () => {
            this.client.send("shutdown_notebook", {
        ...
        this.fold_selected = (new_val) => {
            if (lodash_js_1.default.isEmpty(this.state.selected_cells))
                return;
        ...
        this.move_selected = (/** @type {KeyboardEvent} */ e, /** @type {1|-1} */ delta) => {
            if (this.state.selected_cells.length > 0) {
                ...
                // scroll into view
                () => {
                    document.getElementById((delta > 0 ? lodash_js_1.default.last : lodash_js_1.default.first)(this.state.selected_cells) ?? "")?.scrollIntoView({ block: "nearest" });
                });
            }
        };
        this.serialize_selected = (/** @type {string?} */ cell_id = null) => {
            ...
            if (cells_to_serialize.length) {
                return (0, Serialization_js_1.serialize_cells)(cells_to_serialize.map((id) => this.state.notebook.cell_inputs[id]));
            }
        };
        ...
        document.addEventListener("keyup", (e) => {
            set_ctrl_down((0, KeyboardShortcuts_js_1.has_ctrl_or_cmd_pressed)(e));
        });
        ...
        document.addEventListener("keydown", (e) => {
            ...
            //     return
            // }
            if (e.key?.toLowerCase() === "q" && (0, KeyboardShortcuts_js_1.has_ctrl_or_cmd_pressed)(e)) {
            ...
            else if (e.key?.toLowerCase() === "s" && (0, KeyboardShortcuts_js_1.has_ctrl_or_cmd_pressed)(e)) {
            ...
            else if (["BracketLeft", "BracketRight"].includes(e.code) && (KeyboardShortcuts_js_1.is_mac_keyboard ? e.altKey && e.metaKey : e.ctrlKey && e.shiftKey)) {
            ...
            else if ((e.key === "?" && (0, KeyboardShortcuts_js_1.has_ctrl_or_cmd_pressed)(e)) || e.key === "F1") {
                // On mac "cmd+shift+?" is used by chrome, so that is why this needs to be ctrl as well on mac
                // Also pressing "ctrl+shift" on mac causes the key to show up as "/", this madness
                // I hope we can find a better solution for this later - Dral
                const fold_prefix = KeyboardShortcuts_js_1.is_mac_keyboard ? `⌥${KeyboardShortcuts_js_1.and}⌘` : `Ctrl${KeyboardShortcuts_js_1.and}Shift`;
                alert(`
⇧${KeyboardShortcuts_js_1.and}Enter:   run cell
${KeyboardShortcuts_js_1.ctrl_or_cmd_name}${KeyboardShortcuts_js_1.and}Enter:   run cell and add cell below
${KeyboardShortcuts_js_1.ctrl_or_cmd_name}${KeyboardShortcuts_js_1.and}S:   submit all changes
Delete or Backspace:   delete empty cell

PageUp or fn${KeyboardShortcuts_js_1.and}↑:   jump to cell above
PageDown or fn${KeyboardShortcuts_js_1.and}↓:   jump to cell below
${KeyboardShortcuts_js_1.control_name}${KeyboardShortcuts_js_1.and}click:   jump to definition
${KeyboardShortcuts_js_1.alt_or_options_name}${KeyboardShortcuts_js_1.and}↑:   move line/cell up
${KeyboardShortcuts_js_1.alt_or_options_name}${KeyboardShortcuts_js_1.and}↓:   move line/cell down

${KeyboardShortcuts_js_1.control_name}${KeyboardShortcuts_js_1.and}/:   toggle comment
${KeyboardShortcuts_js_1.control_name}${KeyboardShortcuts_js_1.and}M:   toggle markdown
${fold_prefix}${KeyboardShortcuts_js_1.and}[:   hide cell code
${fold_prefix}${KeyboardShortcuts_js_1.and}]:   show cell code
${KeyboardShortcuts_js_1.ctrl_or_cmd_name}${KeyboardShortcuts_js_1.and}Q:   interrupt notebook

Select multiple cells by dragging a selection box from the space between cells.
${KeyboardShortcuts_js_1.ctrl_or_cmd_name}${KeyboardShortcuts_js_1.and}C:   copy selected cells
${KeyboardShortcuts_js_1.ctrl_or_cmd_name}${KeyboardShortcuts_js_1.and}X:   cut selected cells
${KeyboardShortcuts_js_1.ctrl_or_cmd_name}${KeyboardShortcuts_js_1.and}V:   paste selected cells
...
The notebook file saves every time you run a cell.`);
            ...
            if (this.state.disable_ui && this.state.backend_launch_phase === Binder_js_1.BackendLaunchPhase.wait_for_user) {
        ...
        document.addEventListener("copy", (e) => {
            if (!(0, KeyboardShortcuts_js_1.in_textarea_or_input)()) {
                const serialized = this.serialize_selected();
                if (serialized) {
                    e.preventDefault();
                    // wait one frame to get transient user activation
                    requestAnimationFrame(() => navigator.clipboard.writeText(serialized).catch((err) => {
    ...
    componentDidMount() {
        ...
        if (this.state.static_preview) {
            ...
            // view stats on https://stats.plutojl.org/
            (0, Binder_js_1.count_stat)(lp.pluto_server_url != null
            ...
            this.connect(lp.pluto_server_url ? (0, PlutoConnection_js_1.ws_address_from_base)(lp.pluto_server_url) : undefined);
        }
    }
    componentDidUpdate(/** @type {EditorProps} */ old_props, /** @type {EditorState} */ old_state) {
        ...
        if (old_state?.notebook?.path !== new_state.notebook.path) {
            (0, exports.update_stored_recent_notebooks)(new_state.notebook.path, old_state?.notebook?.path);
        }
        if (old_state?.notebook?.shortpath !== new_state.notebook.shortpath) {
            if (!(0, editor_js_1.is_editor_embedded_inside_editor)(old_props.pluto_editor_element))
        ...
        if (old_state.backend_launch_phase !== this.state.backend_launch_phase && this.state.backend_launch_phase != null) {
            const phase = Object.entries(Binder_js_1.BackendLaunchPhase).find(([k, v]) => v == this.state.backend_launch_phase)?.[0];
        ...
        if (!this.state.initializing) {
            (0, SetupMathJax_js_1.setup_mathjax)();
        }
    ...
    render() {
        ...
        if (status.isolated_cell_view) {
            return (0, Preact_js_1.html) `
                <${PlutoContext_js_1.PlutoActionsContext.Provider} value=${this.actions}>
                    <${PlutoContext_js_1.PlutoBondsContext.Provider} value=${this.state.notebook.bonds}>
                        <${PlutoContext_js_1.PlutoJSInitializingContext.Provider} value=${this.js_init_set}>
                            <${ProgressBar_js_1.ProgressBar} notebook=${this.state.notebook} backend_launch_phase=${this.state.backend_launch_phase} status=${status}/>
                            <div style="width: 100%">
                                ${this.state.notebook.cell_order.map((cell_id, i) => (0, Preact_js_1.html) `
                                        <${Cell_js_1.IsolatedCell}
                        ...
                        </${PlutoContext_js_1.PlutoJSInitializingContext.Provider}>
                    </${PlutoContext_js_1.PlutoBondsContext.Provider}>
                </${PlutoContext_js_1.PlutoActionsContext.Provider}>
            `;
        }
        ...
        const restart = async (maybe_confirm = false) => {
            ...
            if (!warn_about_untrusted_code ||
                ...
                await this.client.send("restart_process", {}, {
                    notebook_id: notebook.notebook_id,
                });
            }
        };
        const restart_button = (text, maybe_confirm = false) => (0, Preact_js_1.html) `<a href="#" id="restart-process-button" onClick=${() => restart(maybe_confirm)}>${text}</a>`;
        return (0, Preact_js_1.html) `
            ${this.state.disable_ui === false && (0, Preact_js_1.html) `<${HijackExternalLinksToOpenInNewTab_js_1.HijackExternalLinksToOpenInNewTab} />`}
            <${PlutoContext_js_1.PlutoActionsContext.Provider} value=${this.actions}>
                <${PlutoContext_js_1.PlutoBondsContext.Provider} value=${this.state.notebook.bonds}>
                    <${PlutoContext_js_1.PlutoJSInitializingContext.Provider} value=${this.js_init_set}>
            ...
            : null}
                    <${Scroller_js_1.Scroller} active=${this.state.scroller} />
                    <${ProgressBar_js_1.ProgressBar} notebook=${this.state.notebook} backend_launch_phase=${this.state.backend_launch_phase} status=${status}/>
                    <header id="pluto-nav" className=${export_menu_open ? "show_export" : ""}>
                        <${ExportBanner_js_1.ExportBanner}
                            notebook_id=${this.state.notebook.notebook_id}
                            print_title=${this.state.notebook.metadata?.frontmatter?.title ??
            ...
            this.state.notebook.shortpath}
                        ...
                        />
                        ${status.binder
            ? (0, Preact_js_1.html) `<div id="binder_spinners">
            ...
            : null}
                        <nav id="at_the_top">
                            <a href=${this.state.binder_session_url != null ? `${this.state.binder_session_url}?token=${this.state.binder_session_token}` : "./"}>
                                <h1><img id="logo-big" src=${url_logo_big} alt="Pluto.jl" /><img id="logo-small" src=${exports.url_logo_small} /></h1>
                            </a>
                            ${this.state.extended_components.CustomHeader &&
            (0, Preact_js_1.html) `<${this.state.extended_components.CustomHeader} notebook_id=${this.state.notebook.notebook_id} />`}
                            <div class="flex_grow_1"></div>
                            ${this.state.extended_components.CustomHeader == null &&
            (status.binder
                ? (0, Preact_js_1.html) `<pluto-filepicker><a href=${this.export_url("notebookfile")} target="_blank">Save notebook...</a></pluto-filepicker>`
                : (0, Preact_js_1.html) `<${FilePicker_js_1.FilePicker}
                    ...
                    base: this.client.session_options?.server?.notebook_path_suggestion ?? "",
                            ...
                            <div id="process_status">${status.binder && status.loading
            ? "Loading binder..."
            : statusval === "disconnected"
                ...
                : statusval === "loading"
                    ...
                    : statusval === "nbpkg_restart_required"
                        ? (0, Preact_js_1.html) `${restart_button("Restart notebook")}${" (required)"}`
                        : statusval === "nbpkg_restart_recommended"
                            ? (0, Preact_js_1.html) `${restart_button("Restart notebook")}${" (recommended)"}`
                            : statusval === "process_restarting"
                                ? "Process exited — restarting..."
                                : statusval === "process_dead"
                                    ? (0, Preact_js_1.html) `${"Process exited — "}${restart_button("restart")}`
                                    : statusval === "process_waiting_for_permission"
                                        ? (0, Preact_js_1.html) `${restart_button("Run notebook code", true)}`
                                        : null}</div>
            ...
            this.setState({ export_menu_open: !export_menu_open });
                    ...
                    <${SafePreviewUI_js_1.SafePreviewUI}
                    ...
                    />
                    <${RecordingUI_js_1.RecordingPlaybackUI} 
                        launch_params=${launch_params}
                        initializing=${this.state.initializing}
                        apply_notebook_patches=${this.apply_notebook_patches}
                        reset_notebook_state=${() => this.setStatePromise((0, immer_js_1.default)((/** @type {EditorState} */ state) => {
            state.notebook = this.props.initial_notebook_state;
        }))}
                    />
                    <${LaunchBackendButton_js_1.EditorLaunchBackendButton} editor=${this} launch_params=${launch_params} status=${status} />
                    <${FrontmatterInput_js_1.FrontMatterInput}
                        filename=${notebook.shortpath}
                        remote_frontmatter=${notebook.metadata?.frontmatter} 
                        set_remote_frontmatter=${(newval) => this.actions.update_notebook((nb) => {
            nb.metadata["frontmatter"] = newval;
        })} 
                    />
                    ${this.props.preamble_element}
                    <${Main}>
                        <${Preamble_js_1.Preamble}
            ...
            (0, Preact_js_1.html) `<${SelectionArea_js_1.SelectionArea}
                ...
                // @ts-ignore
                if (selected_cell_ids.length !== this.state.selected_cells.length ||
                    lodash_js_1.default.difference(selected_cell_ids, this.state.selected_cells).length !== 0) {
                    this.setState({
                        ...
                        />`}
                    <${BottomRightPanel_js_1.BottomRightPanel}
            ...
            this.update_notebook((notebook) => {
                ...
                this.actions.set_and_run_multiple(rd.map(({ cell }) => cell.cell_id));
                    ...
                    />
                    <${SlideControls_js_1.SlideControls} />
                    <footer>
                        <div id="info">
...
const update_stored_recent_notebooks = (recent_path, /** @type {string | undefined} */ also_delete = undefined) => {
    if (recent_path != null && recent_path !== exports.default_path) {
        ...
        if (!lodash_js_1.default.isEqual(oldpaths, newpaths)) {
            localStorage.setItem("recent notebooks", JSON.stringify(newpaths.slice(0, 50)));
        }
    }
};
exports.update_stored_recent_notebooks = update_stored_recent_notebooks;
