...
exports.SlideControls = void 0;
const Preact_js_1 = require("../imports/Preact.js");
const SlideControls = () => {
    const button_prev_ref = (0, Preact_js_1.useRef)(/** @type {HTMLButtonElement?} */ (null));
    const button_next_ref = (0, Preact_js_1.useRef)(/** @type {HTMLButtonElement?} */ (null));
    const [presenting, set_presenting] = (0, Preact_js_1.useState)(false);
    ...
    const presenting_ref = (0, Preact_js_1.useRef)(false);
    ...
    (0, Preact_js_1.useLayoutEffect)(() => {
        ...
        if (!presenting)
            return; // We do not add listeners if not presenting
...
exports.SlideControls = SlideControls;
