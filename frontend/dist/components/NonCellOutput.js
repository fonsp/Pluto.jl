...
const NonCellOutput = ({ environment_component, notebook_id }) => {
    const surely_the_latest_updated_set = (0, Preact_js_1.useRef)();
    const [component_set, update_component_set] = (0, Preact_js_1.useState)({});
    (0, useEventListener_js_1.useEventListener)(document, "eexperimental_add_node_non_cell_output", (e) => {
        try {
    ...
    return (0, Preact_js_1.html) `<div class="non-cell-output">
        ${environment_component ? (0, Preact_js_1.html) `<${environment_component} notebook_id=${notebook_id} />` : null} ${components}
    </div>`;
};
exports.NonCellOutput = NonCellOutput;
