...
exports.Notebook = exports.useMemoDebug = void 0;
...
const useMemoDebug = (fn, args) => {
    const last_values = (0, Preact_js_1.useRef)(args);
...
exports.useMemoDebug = useMemoDebug;
const CellMemo = ({ cell_result, cell_input, cell_input_local, notebook_id, cell_dependencies, selected, focus_after_creation, force_hide_input, is_process_ready, disable_input, sanitize_html = true, process_waiting_for_permission, show_logs, set_show_logs, nbpkg, global_definition_locations, is_first_cell, }) => {
    ...
    return (0, Preact_js_1.useMemo)(() => {
        ...
        sanitize_html,
        ...(0, PkgStatusMark_js_1.nbpkg_fingerprint)(nbpkg),
 ...
 * }} props
 * */
const Notebook = ({ notebook, cell_inputs_local, last_created_cell, selected_cells, is_initializing, is_process_ready, disable_input, process_waiting_for_permission, sanitize_html = true, }) => {
    ...
    const [cell_outputs_delayed, set_cell_outputs_delayed] = (0, Preact_js_1.useState)(true);
    (0, Preact_js_1.useEffect)(() => {
    ...
    let global_definition_locations = (0, Preact_js_1.useMemo)(() => Object.fromEntries(Object.values(notebook?.cell_dependencies ?? {}).flatMap((x) => Object.keys(x.downstream_cells_map)
        .filter((variable) => !variable.includes("."))
        .map((variable) => [variable, x.cell_id]))), [notebook?.cell_dependencies]);
    ...
    return (0, Preact_js_1.html) `
        ...
        .map((cell_id, i) => (0, Preact_js_1.html) `<${CellMemo}
                        key=${cell_id}
