...
exports.FetchProgress = exports.read_Uint8Array_with_progress = void 0;
...
exports.read_Uint8Array_with_progress = read_Uint8Array_with_progress;
const FetchProgress = ({ progress }) => progress == null || progress === 1
    ? null
    : (0, Preact_js_1.html) `<progress class="statefile-fetch-progress" max="100" value=${progress === "indeterminate" ? undefined : Math.round(progress * 100)}>
