...
const Welcome_js_1 = require("./components/welcome/Welcome.js");
...
// @ts-ignore
(0, Preact_js_1.render)((0, Preact_js_1.html) `<${Welcome_js_1.Welcome} launch_params=${launch_params} />`, document.querySelector("#app"));
