// Bundled i18next TypeScript declarations
// Generated from https://cdn.jsdelivr.net/npm/i18next@25.3.2/index.d.ts
 ...
 * Can be provided as a singleton or as a prototype constructor (preferred for supporting multiple instances
 of i18next).
                             * For singleton set property `type` to `'backend'`
