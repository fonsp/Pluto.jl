...
declare abstract class Text$1 implements Iterable<string> {
    ...
    */
    lineAt(pos: number): Line$2;
    /**
    Get the description for the given (1-based) line number.
    */
    line(n: number): Line$2;
    /**
...
declare class Facet$1<Input, Output = readonly Input[]> {
    ...
    */
    from(field: StateField$1<Input>): Extension$1;
...
declare class Compartment {
    ...
    */
    reconfigure(content: Extension$1): StateEffect$1<unknown>;
    /**
    Get the current content of the compartment in the state, or
    `undefined` if it isn't present.
    */
    get(state: EditorState$1): Extension$1 | undefined;
}
...
declare class EditorState$1 {
    ...
    */
    replaceSelection(text: string | Text$1): {
        changes: ChangeSet$1;
        selection: EditorSelection$1;
...
declare type StateCommand = (target: {
    state: EditorState$1;
    dispatch: (transaction: Transaction$1) => void;
}) => boolean;
...
declare class Tree$1 {
    ...
    static empty: Tree$1;
    cursor(pos?: number, side?: -1 | 0 | 1): TreeCursor$1;
    fullCursor(): TreeCursor$1;
    get topNode(): SyntaxNode$1;
    resolve(pos: number, side?: -1 | 0 | 1): any;
    resolveInner(pos: number, side?: -1 | 0 | 1): any;
    iterate(spec: {
        enter(type: NodeType$1, from: number, to: number, get: () => SyntaxNode$1): false | void;
        leave?(type: NodeType$1, from: number, to: number, get: () => SyntaxNode$1): void;
        from?: number;
        to?: number;
    }): void;
    prop<T>(prop: NodeProp$1<T>): T | undefined;
...
interface SyntaxNode$1 {
    ...
    enter(pos: number, side: -1 | 0 | 1, overlays?: boolean, buffers?: boolean): SyntaxNode$1 | null;
...
declare function parseMixed(nest: (node: TreeCursor$1, input: Input$1) => NestedParse | null): ParseWrapper;
...
declare class EditorView {
    ...
    */
    bidiSpans(line: Line$2): readonly BidiSpan[];
    /**
    ...
    */
    static scrollTo: StateEffectType$1<SelectionRange$1>;
    /**
    ...
    *Deprecated*. Use [`scrollIntoView`](https://codemirror.net/6/docs/ref/#view.EditorView^scrollIntoView) instead.
    */
    static centerOn: StateEffectType$1<SelectionRange$1>;
    /**
    ...
    */
    static decorations: Facet$1<DecorationSet, readonly DecorationSet[]>;
    /**
...
*/
declare const keymap: Facet$1<readonly KeyBinding[], readonly (readonly KeyBinding[])[]>;
...
declare class Language$1 {
    ...
    */
    ...
    The node type of the top node of trees produced by this parser.
    */
    topNode: NodeType$1, extraExtensions?: Extension$1[]);
    /**
    Query whether this language is active at the given position.
    */
    isActiveAt(state: EditorState$1, pos: number, side?: -1 | 0 | 1): boolean;
    /**
    Find the document regions that were parsed using this language.
    The returned regions will _include_ any nested languages rooted
    in this language, when those exist.
    */
    findRegions(state: EditorState$1): {
        from: number;
        to: number;
    }[];
    /**
...
parsers.
*/
declare class LRLanguage extends Language$1 {
...
*/
declare function syntaxTree(state: EditorState$1): Tree$1;
/**
...
*/
declare class LanguageSupport$1 {
    /**
    The language object.
    */
    readonly language: Language$1;
    /**
...
declare class LanguageDescription {
    ...
    */
    support: LanguageSupport$1 | undefined;
    private loading;
    private constructor();
    /**
    ...
    */
    load(): Promise<LanguageSupport$1>;
    /**
...
*/
declare const indentUnit: Facet$1<string, string>;
/**
...
parser.
*/
declare class StreamLanguage<State> extends Language$1 {
    private constructor();
...
interface LineNumberConfig {
    ...
    to string.
    */
    formatNumber?: (lineNo: number, state: EditorState$1) => string;
    /**
...
declare class HighlightStyle {
    ...
    */
    match(tag: Tag, scope: NodeType$1): string | null;
    /**
    Combines an array of highlight styles into a single match
    function that returns all of the classes assigned by the styles
    for a given tag.
    */
    static combinedMatch(styles: readonly HighlightStyle[]): (tag: Tag, scope: NodeType$1) => any;
    /**
    ...
    */
    static get(state: EditorState$1, tag: Tag, scope?: NodeType$1): string | null;
}
/**
...
interface CompletionConfig {
    ...
    */
    addToOptions?: {
        render: (completion: Completion, state: EditorState$1) => Node | null;
        position: number;
    }[];
}
...
*/
declare const pickedCompletion: AnnotationType$1<Completion>;
...
*/
declare const snippetKeymap: Facet$1<readonly KeyBinding[], readonly KeyBinding[]>;
/**
...
returns `null`.
*/
declare function completionStatus(state: EditorState$1): null | "active" | "pending";
/**
Returns the available completions as an array.
*/
declare function currentCompletions(state: EditorState$1): readonly Completion[];
/**
Return the currently selected completion, if any.
*/
declare function selectedCompletion(state: EditorState$1): Completion | null;
...
*/
declare const markdownLanguage: Language$1;
/**
...
declare function markdown(config?: {
    ...
    blocks.
    */
    defaultCodeLanguage?: Language$1 | LanguageSupport$1;
    /**
...
extensions.
*/
declare function sql(config?: SQLConfig): LanguageSupport$1;
/**
...
*/
declare function python(): LanguageSupport$1;
...
declare type CollabConfig = {
    ...
    */
    ...
    changes come in.
    */
    sharedEffects?: (tr: Transaction$1) => readonly StateEffect$1<any>[];
};
/**
Create an instance of the collaborative editing plugin.
*/
declare function collab(config?: CollabConfig): Extension$1;

export { Annotation$1 as Annotation, Compartment, Decoration, EditorSelection$1 as EditorSelection, EditorState$1 as EditorState, EditorView, Facet$1 as Facet, HighlightStyle, NodeProp$1 as NodeProp, PostgreSQL, SelectionRange$1 as SelectionRange, StateEffect$1 as StateEffect, StateField$1 as StateField, StreamLanguage, Text$1 as Text, Transaction$1 as Transaction, TreeCursor$1 as TreeCursor, ViewPlugin, ViewUpdate, WidgetType, index as autocomplete, bracketMatching, closeBrackets, closeBracketsKeymap, collab, combineConfig, commentKeymap, completionKeymap, defaultHighlightStyle, defaultKeymap, drawSelection, foldGutter, foldKeymap, highlightSelectionMatches, highlightSpecialChars, history, historyKeymap, html, htmlLanguage, indentLess, indentMore, indentOnInput, indentUnit, javascript, javascriptLanguage, julia as julia_andrey, julia$1 as julia_legacy, keymap, lineNumbers, markdown, markdownLanguage, parseCode, parseMixed, placeholder, python, pythonLanguage, rectangularSelection, searchKeymap, sql, syntaxTree, tags };
