...
;(function () {
    ...
    */
    ...
    // closeBtn.innerHTML = '<a href="javascript:void(0)" class="closebtn">×</a>'
    ...
    // titleDiv.innerHTML = '<h2> <img width="35"  src="./img/jive_logo_eye_crop3.png"></img> <i>JIVE</i    >   </h2> v.0.0'
    ...
    // OBSOLETE BUTTON
    // const accStartJIVE = document.createElement("a")
    // accStartJIVE.href = "#"
    // accStartJIVE.className = "jv-bar-item jv-button"
    // accStartJIVE.innerText = "Start JIVE Core"
    // accStartJIVE.onclick = function () {
    //     createCellWithCode(
    //         'begin \n import Pkg \n # Pkg.add(url="https://github.com/bmandracchia/JIVECore.jl") \n Pkg.add(path="/home/export/personal/pvilayl/JIVE/JIVECore.jl/") \n import JIVECore \nend'
    //     )
    // }
    ...
    // sideBar.appendChild(accStartJIVE)
