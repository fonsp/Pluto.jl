...
#######################**************************########################`,
    ...
    render() {
        ...
        const [notebookfile_url, notebookexport_url] = ["notebookfile", "notebookexport"].map((u) =>
            ...
            <${PlutoContext.Provider} value=${this.actions}>
                <${PlutoBondsContext.Provider} value=${this.state.notebook.bonds}>
                    ...
                    <header className=${export_menu_open ? "show_export" : ""}>
                        <${ExportBanner}
                            notebookfile_url=${notebookfile_url}
                            notebookexport_url=${notebookexport_url}
                        ...
                        <nav id="at_the_top">
                            ...
                            ${
                                this.state.binder_phase === BinderPhase.ready
                                    ? html`<pluto-filepicker><a href=${notebookfile_url} target="_blank">Save notebook...</a></pluto-filepicker>`
                                    : html`<${FilePicker}
                                          client=${this.client}
